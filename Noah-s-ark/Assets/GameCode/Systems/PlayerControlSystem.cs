    ...
    protected override void OnUpdate()
    {
        ...
        for (int i = 0; i < playerData.Length; i++)
        {
            ...
            if(playerInput.Shoot && playerTurnState.PlayersTurn)
            {
                ...
                PostUpdateCommands.SetComponent(entity, new VelocityComponent { Value =  new float3(0, 0, playerFaction.Faction == Factions.Enemy ? -settings.bulletSpeed: settings.bulletSpeed)});
